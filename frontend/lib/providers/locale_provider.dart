...
class AppTranslations {
  static const Map<String, Map<String, String>> translations = {
    'en': {
      ...
      'timetable_created': 'Entry created!',
      'timetable_updated': 'Entry updated!',
      'timetable_deleted': 'Entry deleted.',
      ...
      'settings': 'Settings',
      'timetable': 'Timetable',
      'add_timetable': 'Add Entry',
      'edit_timetable': 'Edit Entry',
      'confirm_delete_timetable': 'Delete this timetable entry?',
      'day': 'Day',
      'period': 'Period',
      'time_info': 'Time Info',
      ...
      'no_timetable_data': 'No timetable entries',
    ...
    'km': {
      ...
      'timetable_created': 'បន្ថែមធាតុបានជោគជ័យ!',
      'timetable_updated': 'កែប្រែធាតុបានជោគជ័យ!',
      'timetable_deleted': 'លុបធាតុបានជោគជ័យ',
      ...
      'settings': 'ការកំណត់',
      'timetable': 'ពេលវេលា',
      'add_timetable': 'បន្ថែមធាតុ',
      'edit_timetable': 'កែប្រែធាតុ',
      'confirm_delete_timetable': 'លុបធាតុពេលវេលានេះ?',
      'day': 'ថ្ងៃ',
      'period': 'វគ្គ',
      'time_info': 'ពេលវេលា',
      'select_day': 'ជ្រើសថ្ងៃ',
      'select_period': 'ជ្រើសវគ្គ',
      'select_teacher': 'ជ្រើសគ្រូ',
      'room': 'បន្ទប់',
      'room_hint': 'ឧ. បន្ទប់ 101',
      'no_timetable_data': 'គ្មានធាតុពេលវេលា',
      'no_classes': 'គ្មានថ្នាក់',
      'all_teachers': 'គ្រូទាំងអស់',
      'all_days': 'គ្រប់ថ្ងៃ',
      'none': 'គ្មាន',
      'reset': 'កំណត់ឡើងវិញ',
      'teacher': 'គ្រូ',
      ...
      'sep': 'កញ្ញា', 'oct': 'តុលា', 'nov': 'វិច្ឆកា', 'dec': 'ធ្នូ',
      'reports': 'របាយការណ៍',
      'profile': 'ប្រវត្តិ',
      // Dashboard
      'welcome': 'សូមស្វាគមន៍',
